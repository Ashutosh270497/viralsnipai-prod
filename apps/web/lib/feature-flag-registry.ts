...
export const FEATURE_FLAG_REGISTRY: Record<FeatureFlagKey, FeatureFlagDefinition> = {
  ...
  youtubeRepurposeOsEnabled: {
    ...
    stage: "experiment",
    defaultValue: false,
    description: "RepurposeOS — YouTube content repurposing workspace.",
    killSwitchBehavior: "Keep false until RepurposeOS is launch-ready.",
    removeWhen: "Remove once RepurposeOS is GA.",
  },
