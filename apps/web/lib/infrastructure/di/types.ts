...
export const TYPES = {
  ...
  ClipCandidateGenerationService: Symbol.for('ClipCandidateGenerationService'),
  ClipRerankingService: Symbol.for('ClipRerankingService'),
  ClipBoundaryRefinementService: Symbol.for('ClipBoundaryRefinementService'),
