    ...
    <div className="mx-auto flex w/full max-w-4xl flex-col gap-10 px-6 py-12">
      <div className="space-y-4 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Marketplace creators keep 70% of each sale. Payouts run monthly via Stripe, with support for team splits and promotional codes.
        </p>
      </div>
      <Card className="border border-border/70 bg-card/80 shadow-sm">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          <p>• 70% creator share, 30% Clippers platform fee.</p>
