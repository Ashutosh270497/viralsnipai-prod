...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {isActive && (
        <span
          className="absolute left-0 inset-y-2 w-[3px] rounded-r-full bg-white/90"
...
export function WorkspaceNav({ user, ecosystem, onNavigate }: WorkspaceNavProps) {
  ...
  const sections: NavSection[] = [
    ...
    { title: "Advanced", links: productionTools },
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="space-y-5">
          {sections.map((section) => (
            <div key={section.title}>
              <p className="mb-2 px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-muted-foreground select-none">
                {section.title}
              </p>
      ...
      <div className="shrink-0 border-t border-border/70 bg-muted/20">
        <div className="space-y-1 px-3 py-3">
          ...
          <Link
            ...
            className="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-muted-foreground transition-all duration-150 hover:bg-muted/70 hover:text-foreground"
          >
        ...
        {user && (
          <div className="px-3 pb-4">
            <div className="flex cursor-pointer items-center gap-2.5 rounded-2xl border border-border/70 bg-card/80 px-3 py-3 shadow-sm transition-all duration-150 hover:border-primary/30">
